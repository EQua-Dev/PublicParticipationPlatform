...
class CitizenRegistrationViewModel @Inject constructor(
    ...
    fun onEvent(event: CitizenRegistrationEvent) {
        when (event) {
            ...
            is CitizenRegistrationEvent.PasswordChanged -> {
            ...
            is CitizenRegistrationEvent.CountryChanged -> {
                _state.value = _state.value.copy(country = event.country)
            }
...
//                profileImage = _state.value.profileImage,
            ...
            // Register citizen
            val registerResult = repository.registerCitizen(
                citizen,
